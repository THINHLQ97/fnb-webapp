      ...
      <div className='mx-auto max-w-3xl'>
        ...
        <div className='space-y-8'>
          ...
          <section className='bg-card rounded-2xl border p-8 shadow-sm'>
            ...
            <p className='text-muted-foreground text-lg leading-relaxed'>
              Xác thực được xử lý bởi Auth.js với hỗ trợ đăng nhập bằng email/mật khẩu và Google OAuth.
              Phân quyền RBAC (ADMIN / EDITOR / MANAGER / STAFF) kiểm soát truy cập các tính năng.
            </p>
          </section>
