  ...
  return (
    <div className='min-h-screen px-4 py-12 sm:px-6 lg:px-8'>
      <div className='mx-auto max-w-3xl space-y-8'>
        ...
        <section>
          <h2 className='text-foreground mb-3 text-xl font-semibold'>Xác thực</h2>
          <p className='text-muted-foreground text-base leading-relaxed'>
            Ứng dụng sử dụng Auth.js để xử lý xác thực người dùng một cách an toàn.
            Tất cả quy trình đăng ký, đăng nhập và quản lý mật khẩu đều được xử lý
            thông qua Auth.js với các phương thức đăng nhập bằng tài khoản và Google OAuth.
          </p>
        </section>
